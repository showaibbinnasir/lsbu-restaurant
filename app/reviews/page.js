    ...
    <div className='my-5'>
      <div className='bg-[#D9D9D9] p-5 flex flex-col lg:flex-row gap-5'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div>
            <h1>If youre looking for a cozy, welcoming restaurant with incredible food and top-notch service, The LSBU Resturaunt  the place to be. From the moment you step in, the warm ambiance and soft lighting create the perfect setting for a relaxed dining experience.
